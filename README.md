...
## Development tips
- Use `-Xmx` VM option to increase heap when running large searches.
- Use a profiler (VisualVM) to find allocation/GC hotspots.

## Questions / next steps
- Do you want a CLI-only solver (no GUI)?
- Should I add a one-page description of the cube indexing (sticker indices) so you can map moves easily?

## License
No license is specified. Add a `LICENSE` file if you want to publish/redistribute.