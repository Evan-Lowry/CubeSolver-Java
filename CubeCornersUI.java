...
public class CubeCornersUI extends JPanel {
    private static CubeCorner cubeCorner;
    ...
    public CubeCornersUI() {
        cubeCorner = Main.cubeCorner;
        // sets size of window
    ...
    public static void showWindow(CubeCorner cubeCorner) {
        SwingUtilities.invokeLater(() -> {
            if (frame == null) {
                CubeCornersUI ui = new CubeCornersUI();
                ...
                CubeCornersUI.cubeCorner = cubeCorner;
                frame.repaint();
            }
        });
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        drawing.drawCorners(g2);

        g2.dispose();
    }

    public static byte[] getCube() {
        return cubeCorner.getCube();
    }

    public static void performMoves(String move) {
        cubeCorner.performMoves(move);
        refresh();
    }

    public static void applyMove(int move) {
        cubeCorner.applyMove(move);
        refresh();
    }
